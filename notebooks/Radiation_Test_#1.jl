...
plot!(wle,leaf.Mf[ind_wlf_R,:], color=[:black],line=(:dash,2), label="Forward SIF, excited at $wl_Red nm" )
plot!(wle,leaf.Mb[ind_wlf_R,:], color=[:orange],line=(:dash,2), label="Backward SIF, excited at $wl_Red nm" )
