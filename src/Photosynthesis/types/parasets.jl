...
function VpmaxTDBoyd(FT)
    ...
    ΔHd_to_R   ::FT = 73300.0 / gas_constant();
    ΔSv_to_R   ::FT = 250.0   / gas_constant();
...
function JmaxTDLeuning(FT)
    ...
    ΔHd_to_R   ::FT = 152044.0 / gas_constant();
    ΔSv_to_R   ::FT = 495.0    / gas_constant();
    C          ::FT = 1 + exp( ΔSv_to_R - ΔHd_to_R/T_25(FT) );
    return ArrheniusPeakTD{FT}(ΔHa_to_RT25, ΔHd_to_R, ΔSv_to_R, C)
end
...
function VcmaxTDLeuning(FT)
    ...
    ΔHd_to_R   ::FT = 149252.0 / gas_constant();
    ΔSv_to_R   ::FT = 486.0    / gas_constant();
    C          ::FT = 1 + exp( ΔSv_to_R - ΔHd_to_R/T_25(FT) );
    return ArrheniusPeakTD{FT}(ΔHa_to_RT25, ΔHd_to_R, ΔSv_to_R, C)
end
...
function JmaxTDBernacchi(FT)
    ...
    ΔHd_to_R   ::FT = 439000.0 / gas_constant();
    ΔSv_to_R   ::FT = 1400.0   / gas_constant();
    C          ::FT = 1 + exp( ΔSv_to_R - ΔHd_to_R/T_25(FT) );
    return ArrheniusPeakTD{FT}(ΔHa_to_RT25, ΔHd_to_R, ΔSv_to_R, C)
end
...
function JmaxTDCLM(FT)
    ...
    ΔHd_to_R   ::FT = 150000.0 / gas_constant();
    ΔSv_to_R   ::FT = 490.0    / gas_constant();
    C          ::FT = 1 + exp( ΔSv_to_R - ΔHd_to_R/T_25(FT) );
    return ArrheniusPeakTD{FT}(ΔHa_to_RT25, ΔHd_to_R, ΔSv_to_R, C)
end
...
function RespirationTDCLM(FT)
    ...
    ΔHd_to_R   ::FT = 150650.0 / gas_constant();
    ΔSv_to_R   ::FT = 490.0    / gas_constant();
    C          ::FT = 1 + exp( ΔSv_to_R - ΔHd_to_R/T_25(FT) );
    return ArrheniusPeakTD{FT}(ΔHa_to_RT25, ΔHd_to_R, ΔSv_to_R, C)
end
