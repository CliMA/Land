...
#
#######################################################################################################################################################################################################
KcTDBernacchi(FT)          = Arrhenius{FT}(T_REF = T_25(), VAL_REF = 41.0264925, ΔHA = 79430.0);
KcTDCLM(FT)                = Arrhenius{FT}(T_REF = T_25(), VAL_REF = 40.49     , ΔHA = 79430.0);
KoTDBernacchi(FT)          = Arrhenius{FT}(T_REF = T_25(), VAL_REF = 28208.88  , ΔHA = 36380.0);
KoTDCLM(FT)                = Arrhenius{FT}(T_REF = T_25(), VAL_REF = 27840.0   , ΔHA = 36380.0);
KpepTDCLM(FT)              = Arrhenius{FT}(T_REF = T_25(), VAL_REF = 8.0       , ΔHA = 36000.0);
KpepTDBoyd(FT)             = Arrhenius{FT}(T_REF = T_25(), VAL_REF = 16.0      , ΔHA = 36300.0);
KqTDJohnson(FT)            = Arrhenius{FT}(T_REF = T_25(), VAL_REF = 300       , ΔHA = 37000.0);
RespirationTDBernacchi(FT) = Arrhenius{FT}(T_REF = T_25(), VAL_REF = NaN       , ΔHA = 46390.0);
VcmaxTDBernacchi(FT)       = Arrhenius{FT}(T_REF = T_25(), VAL_REF = NaN       , ΔHA = 65330.0);
VomaxTDBernacchi(FT)       = Arrhenius{FT}(T_REF = T_25(), VAL_REF = NaN       , ΔHA = 60110.0);
ΓStarTDBernacchi(FT)       = Arrhenius{FT}(T_REF = T_25(), VAL_REF = 4.33164375, ΔHA = 37830.0);
ΓStarTDCLM(FT)             = Arrhenius{FT}(T_REF = T_25(), VAL_REF = 4.275     , ΔHA = 37830.0);

JmaxTDBernacchi(FT)                = ArrheniusPeak{FT}(T_REF = T_25(), VAL_REF = NaN , ΔHA = 57500.0, ΔHD = 439000.0, ΔSV = 1400.0);
JmaxTDCLM(FT, t::Number = T_25())  = ArrheniusPeak{FT}(T_REF = T_25(), VAL_REF = NaN , ΔHA = 50000.0, ΔHD = 200000.0, ΔSV = 659.70 - 0.75 * (t - T_0()) );
JmaxTDLeuning(FT)                  = ArrheniusPeak{FT}(T_REF = T_25(), VAL_REF = NaN , ΔHA = 50300.0, ΔHD = 152044.0, ΔSV = 495.0 );
RespirationTDCLM(FT)               = ArrheniusPeak{FT}(T_REF = T_25(), VAL_REF = NaN , ΔHA = 46390.0, ΔHD = 150650.0, ΔSV = 490.0 );
VcmaxTDCLM(FT, t::Number = T_25()) = ArrheniusPeak{FT}(T_REF = T_25(), VAL_REF = NaN , ΔHA = 72000.0, ΔHD = 200000.0, ΔSV = 668.39 - 1.07 * (t - T_0()) );
VcmaxTDLeuning(FT)                 = ArrheniusPeak{FT}(T_REF = T_25(), VAL_REF = NaN , ΔHA = 73637.0, ΔHD = 149252.0, ΔSV = 486.0 );
VpmaxTDBoyd(FT)                    = ArrheniusPeak{FT}(T_REF = T_25(), VAL_REF = NaN , ΔHA = 94800.0, ΔHD = 73300.0 , ΔSV = 250.0 );
ΗCTDJohnson(FT)                    = ArrheniusPeak{FT}(T_REF = T_25(), VAL_REF = 1.0 , ΔHA = 0.0    , ΔHD = 220000.0, ΔSV = 710.0 );
ΗLTDJohnson(FT)                    = ArrheniusPeak{FT}(T_REF = T_25(), VAL_REF = 0.75, ΔHA = 0.0    , ΔHD = 220000.0, ΔSV = 710.0 );

Q10TDAngiosperm(FT) = Q10{FT}(Q_10 = 1.4, T_REF = T_25(), VAL_REF = 0.0140/8760);
Q10TDGymnosperm(FT) = Q10{FT}(Q_10 = 1.7, T_REF = T_25(), VAL_REF = 0.0425/8760);
