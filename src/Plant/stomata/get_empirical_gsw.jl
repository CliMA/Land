...
"""
    get_empirical_gsw(curvature::FT, g_ias_c::FT, g_ias_e::FT, g_max::FT, j_max::FT, p_a::FT, p_atm::FT, p_H₂O::FT, p_max::FT, p_O₂::FT, par::FT, qy::FT, r_25::FT, t_leaf::FT, v_max::FT, paraset::AbstractEmpiricalStomatalModel)
...
- `paraset` An AbstractPhotoModelParaSet type parameter set
...
function get_empirical_gsw(
                         curvature::FT,
                           ...
                           g_ias_e::FT,
                            ...
                            t_leaf::FT,
                               v25::FT,
                           paraset::AbstractPhotoModelParaSet,
                             model::AbstractEmpiricalStomatalModel) where {FT}
    gsw_min = paraset.g0
    gsw_max = g_max * (t_leaf / FT(K_25))^1.8
