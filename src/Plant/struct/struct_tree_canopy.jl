...
Base.@kwdef mutable struct StructTreeLeaf
    ...
    par    ::Float32 = 0.0      # μmol m⁻² s⁻¹ | photosynthetic active radiation
    ...
    a_gross::Float32 = 0.0       # μmol m⁻² s⁻¹ | gross photosynthetic rate
    a_net  ::Float32 = 0.0       # μmol m⁻² s⁻¹ | net photosynthetic rate
    e      ::Float32 = 0.0       # mol m⁻² s⁻¹  | flow rate in the xylem
    e_crit ::Float32 = 0.0       # mol m⁻² s⁻¹  | maximal flow rate in the xylem
    gsc    ::Float32 = 0.0       # mol m⁻² s⁻¹  | stomatal conductance for CO₂
    gsw    ::Float32 = 0.0       # mol m⁻² s⁻¹  | stomatal conductance for H₂O
    ...
    r      ::Float32 = 0.0       # μmol m⁻² s⁻¹ | respiration rate
