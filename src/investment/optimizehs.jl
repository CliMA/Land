...
function optimize_hs!(
    ...
    @inline f(x) = (tmp_node = deepcopy(node);
                    ...
                    tmp_node.hs.root.k_element .= tmp_node.hs.root.k_max * 10;
                    tmp_node.hs.stem.k_element .= tmp_node.hs.stem.k_max * 10;
                    tmp_node.hs.leaf.k_element .= tmp_node.hs.leaf.k_sla * 10;
    ...
    node.hs.root.k_element .= node.hs.root.k_max * 10;
    node.hs.stem.k_element .= node.hs.stem.k_max * 10;
    node.hs.leaf.k_element .= node.hs.leaf.k_sla * 10;
