...
"""
    e2phot!(λ::Array{FT,1}, E::Array{FT,1}, cache::Array{FT,1}) where {FT<:AbstractFloat}
...
"""
function e2phot!(λ::Array{FT,1}, E::Array{FT,1}, cache::Array{FT,1}) where {FT<:AbstractFloat}
    cache .= (E .* λ) .* _FAC(FT);
