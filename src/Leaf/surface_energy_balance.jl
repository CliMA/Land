...
"""
function LeafEnergyWaterBalance(Tleaf, psileaf, met::meteo, l::leaf_params,  psi_s=0, U=1)
    ...
    # !!!!! temporary
    #A = met.PAR; # assimilation rate equals PAR for quick test
    ...
    esat,desat_dT = SatVap(Tleaf);
    lv  =  Lv(Tleaf);
    LE          =   physcon.ε/met.P_air*ρd*lv*(esat-met.ea_air)/(1/l.gs+l.ra);
