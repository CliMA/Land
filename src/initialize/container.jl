...
function create_cf_container(
    ...
    return CFContainer{FT}(abs_wave    = abs_wave   ,
...
function create_sf_container(
    ...
    return SFContainer{FT}(τ_dd                 = τ_dd                ,
                           Xdd                  = Xdd                 ,
                           Rdd                  = Rdd                 ,
                           Y                    = Y                   ,
                           U                    = U                   ,
...
function create_sw_container(
    ...
    return SWContainer{FT}(dnorm  = dnorm ,
                           piLo   = piLo  ,
                           piLoc  = piLoc ,
                           piLos  = piLos ,
                           piLoc2 = piLoc2,
...
function create_rt_container(
    ...
    sw_con = create_sw_container(FT, rt_dim);

    return RTContainer{FT}(cf_con = cf_con,
                           cg_con = cg_con,
                           sf_con = sf_con,
                           sw_con = sw_con)
end
