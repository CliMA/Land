...
###############################################################################
"""
    light_limited_rate!(photo_set::C3ParaSet{FT}, leaf::Leaf{FT}) where {FT<:AbstractFloat}
...
"""
    light_limited_rate_glc!(photo_set::C3ParaSet{FT}, leaf::Leaf{FT}, envir::AirLayer{FT}) where {FT<:AbstractFloat}
...
"""
    light_limited_an_glc(photo_set::C3ParaSet{FT}, leaf::Leaf{FT}, envir::AirLayer{FT}, glcs::Array{FT,1}, Js::Array{FT,1}) where {FT<:AbstractFloat}
    light_limited_an_glc(photo_set::C4ParaSet{FT}, leaf::Leaf{FT}, envir::AirLayer{FT}, glcs::Array{FT,1}, Js::Array{FT,1}) where {FT<:AbstractFloat}
...
- `Js` Given array of electron transport rate
"""
